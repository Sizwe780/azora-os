...
export const mockServiceModules: ServiceModuleData[] = [
  {
    id: 'azora-coin',
    name: 'Azora Coin',
    description: 'Cryptographic ledger and token management.',
    icon: DollarSign,
    path: '/azora-coin',
    status: 'operational',
  ...
  },
  {
    ...
    description: 'GDPR, HIPAA, CCPA compliance engine.',
    icon: Shield,
    path: '/compliance',
    status: 'operational',
  ...
  {
    id: 'salezora',
    name: 'Salezora Sales AI',
    description: 'AI-driven sales and marketing optimization.',
    icon: TrendingUp,
    path: '/salezora',
    status: 'operational',
    tags: ['Sales', 'AI'],
  },
  {
    ...
    path: '/marketplace',
    status: 'operational',
    tags: ['Commerce', 'Decentralized'],
  },
  {
    id: 'notification',
    name: 'Notification Service',
    description: 'Proactive AI notifications and alerts.',
    icon: Activity,
    path: '/notification',
    status: 'operational',
