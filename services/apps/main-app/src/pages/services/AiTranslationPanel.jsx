...
import useAiTranslationApi from "../../hooks/useAiTranslationApi";

const AiTranslationPanel = () => {
  const { data, loading, error } = useAiTranslationApi();
  return (
    <div className="card fade-in" style={{ maxWidth: 700, margin: "0 auto" }}>
      <h2 style={{ color: "var(--accent-primary)" }}>AiTranslation Service</h2>
