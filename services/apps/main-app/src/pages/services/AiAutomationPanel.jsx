...
import useAiAutomationApi from "../../hooks/useAiAutomationApi";

const AiAutomationPanel = () => {
  const { data, loading, error } = useAiAutomationApi();
  return (
    <div className="card fade-in" style={{ maxWidth: 700, margin: "0 auto" }}>
      <h2 style={{ color: "var(--accent-primary)" }}>AiAutomation Service</h2>
