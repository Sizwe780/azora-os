...
import useFleetManagementApi from "../../hooks/useFleetManagementApi";

const FleetManagementPanel = () => {
  const { data, loading, error } = useFleetManagementApi();
  return (
    <div className="card fade-in" style={{ maxWidth: 700, margin: "0 auto" }}>
      <h2 style={{ color: "var(--accent-primary)" }}>FleetManagement Service</h2>
