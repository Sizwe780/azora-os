...
app.get('/health', (req, res) => res.json({ status: 'healthy', service: 'partnerships' }));

// Add basic endpoints based on service
if ('partnerships' === 'azora-coin-integration') {
