...
import useSensorFusionApi from "../../hooks/useSensorFusionApi";

const SensorFusionPanel = () => {
  const { data, loading, error } = useSensorFusionApi();
  return (
    <div className="card fade-in" style={{ maxWidth: 700, margin: "0 auto" }}>
      <h2 style={{ color: "var(--accent-primary)" }}>SensorFusion Service</h2>
