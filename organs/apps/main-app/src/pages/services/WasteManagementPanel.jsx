...
import useWasteManagementApi from "../../hooks/useWasteManagementApi";

const WasteManagementPanel = () => {
  const { data, loading, error } = useWasteManagementApi();
  return (
    <div className="card fade-in" style={{ maxWidth: 700, margin: "0 auto" }}>
      <h2 style={{ color: "var(--accent-primary)" }}>WasteManagement Service</h2>
