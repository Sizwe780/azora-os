...
import useAiPersonalizationApi from "../../hooks/useAiPersonalizationApi";

const AiPersonalizationPanel = () => {
  const { data, loading, error } = useAiPersonalizationApi();
  return (
    <div className="card fade-in" style={{ maxWidth: 700, margin: "0 auto" }}>
      <h2 style={{ color: "var(--accent-primary)" }}>AiPersonalization Service</h2>
