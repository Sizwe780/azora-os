...
import useAiForecastingApi from "../../hooks/useAiForecastingApi";

const AiForecastingPanel = () => {
  const { data, loading, error } = useAiForecastingApi();
  return (
    <div className="card fade-in" style={{ maxWidth: 700, margin: "0 auto" }}>
      <h2 style={{ color: "var(--accent-primary)" }}>AiForecasting Service</h2>
