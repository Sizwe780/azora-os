...
app.get('/health', (req, res) => res.json({ status: 'healthy', service: 'user-growth' }));

// Add basic endpoints based on service
if ('user-growth' === 'azora-coin-integration') {
