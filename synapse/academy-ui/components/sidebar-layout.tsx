...
const navigation = [
  ...
  { name: 'Degrees', href: '/degrees', icon: GraduationCap, current: false },
  { name: 'Certificates', href: '/certificates', icon: Award, current: false },
  { name: 'Community', href: '/community', icon: Users, current: false },
  { name: 'Job Market', href: '/marketplace', icon: Briefcase, current: false },
          ...
          <AnimatePresence mode="wait">
            {!sidebarCollapsed ? (
              ...
              >
                ...
                <span className="font-bold text-lg">Azora Academy</span>
              </motion.div>
            ) : (
              <motion.div
                key="collapsed"
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="w-8 h-8 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg flex items-center justify-center mx-auto"
              >
                <BookOpen className="w-4 h-4 text-white" />
              </motion.div>
            )}
              ...
              {!sidebarCollapsed && (
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xs text-gray-500">1,250 AZR</span>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
