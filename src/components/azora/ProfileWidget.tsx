    ...
    return (
        <GlassPanel className="p-5">
            <div className="flex items-center mb-4">
                <User className="w-6 h-6 text-indigo-300 mr-2" />
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <p className="font-bold text-white">{user?.isAnonymous ? 'Anonymous Driver' : user?.uid}</p>
                    <p className="text-sm text-white/60">UID: {user ? `${user.uid.substring(0, 12)}...` : 'N/A'}</p>
                </div>
            </div>
